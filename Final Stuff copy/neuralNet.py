...
class NeuralNet:
    def __init__(self, x, y):
        ...
        neurons = 128#*128 #amountInputs * amountOutputs 
...
net = NeuralNet(trainX/256, trainY)
...
print("Training accuracy : ", accuracy(trainX/256, trainY))
print("Testing accuracy : ", accuracy(testX/256, testY)) 
